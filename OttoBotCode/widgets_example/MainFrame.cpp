...
MainFrame::MainFrame(const wxString& title) : wxFrame(nullptr, wxID_ANY, title) {	
	...
	wxStaticText* staticText = new wxStaticText(panel, wxID_ANY, "StaticText - NOT editable", wxPoint(120, 150), wxSize(400, -1), wxALIGN_CENTER_HORIZONTAL);
	...
	wxRadioBox* radioBox = new wxRadioBox(panel, wxID_ANY, "RadioBox", wxPoint(555, 450), wxDefaultSize, choices, 1, wxRA_SPECIFY_ROWS);
}
